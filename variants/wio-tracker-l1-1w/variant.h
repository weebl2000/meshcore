...
#define PIN_BOOST_EN (31)           // D31 / P0.13 鈥?Grove 5V Boost enable
#define EXT_CHRG_DETECT (32)       // D32 / P1.15 鈥?BQ25616 STAT
...
// LORA_PWR_EN (P0.14): external LDO enable for the SX1262 + 1 W PA on the Pro 1W board.
#define LORA_PWR_EN (33)
